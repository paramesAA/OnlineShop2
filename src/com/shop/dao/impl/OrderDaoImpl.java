...
public class OrderDaoImpl implements IOrderDao {
	...
	public Integer insert(Order order) throws SQLException {
		...
		String sql = "insert into `order`(user_id,order_total,created_time,state,address) values(?, ?, ?,?,?)";
		Object[] params = { order.getUserId(), order.getOrderTotal(), order.getCreatedTime(),order.getState(),order.getAddress()};
	...
	public void update(Order order) throws SQLException {
		...
		Object params[] = { "已发货", order.getOrderId() };
